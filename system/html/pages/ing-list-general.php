...
?>
					...
					<form class="form-horizontal form-validate" role="form" method="post" action="ing-list-general-2.php" id="form1" name="form1" enctype="multipart/form-data" novalidate>
														...
														<div class="row">
															<div class="col-sm-6">
                                                        	    <div class="form-group">
                                                        	        ...
                                                        	        <div class="col-md-10">
                                                        	        <input name="OrdenTrabajo" id="OrdenTrabajo" type="text" class="form-control" placeholder="O.T">
															...
															<div class="col-sm-6">
                                                        	    <div class="form-group">
                                                        	        ...
                                                        	        <div class="col-md-10">
                                                        	        <input name="Factura" id="Factura" type="text" class="form-control" placeholder="Nº Factura">
                                                        	      	<!--<select name="jumpMenu" id="jumpMenu" class="form-control"  onChange="MM_jumpMenu('parent',this,0)" required>
                                                        	      	<?/*
                                                                    if(!empty($Factura))
																	{
														...
														<div class="row">
															...
															<div class="col-sm-6">
                                                        	    <div class="form-group">
                                                        	        ...
                                                        	        <div class="col-md-10">
                                                        	            <input type="text" class="form-control" name="Descripcion" id="Descripcion" value="<?=$Descripción?>" placeholder="Descripcion" onChange="javascript:this.value=this.value.toUpperCase();" required>
                                                        	        </div>
                                                        	    </div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group">
                                                        		    ...
                                                        		    <div class="col-sm-12">
                                                        	         	<textarea name="Observaciones" rows="3" class="form-control" id="Observaciones" placeholder="Detalles / Observaciones" onchange="javascript:this.value=this.value.toUpperCase();"></textarea>
																	</div>
																</div>
															</div>
														</div>
