...
function validar()
{
    ...
    else
	{
        ...
        return false;
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-soporte-3.php"  name="form2" id="form2" novalidate>
                                                        <?
														}
														else
														{
 ...
 <?
		...
		$queryS			="SELECT COUNT(*) AS TOTAL FROM Soporte where Idservicio = '$Id' and Nombre = '$NombreD' and Activo = 0" ;
