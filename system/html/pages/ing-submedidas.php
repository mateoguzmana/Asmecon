...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-submedidas-2.php" novalidate>
                                                        <?
														}
														else
														{
																...
																<div class="col-sm-12">
																	...
																	<input name="Linea" id="Linea" type="hidden" value="<?=$Linea?>">
																	  <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)" required>
																		...
																		{
																		?>
                                                                 		<option value="ing-submedidas.php?Linea=<?=$Linea?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$NombreONE?></option>
                                                                        <?
																		}
																		else{
																		?>
                                                                        ...
                                                                        ?>
                                                                        <option value="ing-submedidas.php?Linea=<?=$Id88?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$Nombre88?></option>
																		<?
																		}
																		?>
                                                                </select>
																...
																<div class="col-sm-12">
																	<label for="Categoria" class="control-label">Categoria</label>
																	 <select name="Categoria" id="Categoria" class="form-control select2-list" data-placeholder="Seleccione Categoria" required>
																		...
																		<?
                                                                        $queryNN		="SELECT * FROM CatMediciones where Linea='$Linea' AND Muestra = 0 order by Nombre";
