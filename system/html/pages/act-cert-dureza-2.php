...
function isNumberKeys(evt)
{
	...
	<body onload="PatronReferencia();Create();Values();">
...
?>
					...
					<form class="form-horizontal form-validate" role="form" method="post" action="act-cert-dureza-3.php" id="form1" name="form1" enctype="multipart/form-data" novalidate>
											...
											<div class="box-body style-white">
														<div class="row">
															...
															<div class="col-sm-6">
                                                        	    <div class="form-group">
                                                        	        ...
                                                        	        <input type="hidden" name="Id" value="<?=$Id?>">
                                                        	      	...
                                                        	      	<?
                                                        	      	$query1 		="SELECT * FROM Clientes WHERE Id<>'$Cliente' AND Muestra=0";
															...
															<div class="col-sm-6">
																...
																<input type="text" value="<?=$Fechax?>" class="form-control" required name="Fecha" id="Fecha"/>
															...
															<div class="col-sm-6">
                                                        	    <div class="form-group">
                                                        	        ...
                                                        	        <div class="col-md-10">
                                                        	      	...
                                                        	      	<option value="<?=$Trazabilidad?>"><?=$instrumento?></option>
                                                        	      	<?
                                                        	      	$queryR 		="SELECT * FROM InstrumentosDOS WHERE Id<>'$Trazabilidad' AND Muestra=0";
															...
															<div class="col-sm-6">
                                                        	    <div class="form-group">
                                                        	        ...
                                                        	        <div class="col-md-10">
                                                        	      	...
                                                        	      	<option value="<?=$TipoDureza?>"><?=$NombreXX?></option>
                                                        	      	<?
														...
														<div class="row">
															<div class="col-sm-6">
                                                        	    <div class="form-group">
                                                        	        <div class="col-lg-2 col-md-4 col-sm-6">
                                                        	            <label class="control-label">Carga aplicada</label>
                                                        	        </div>
                                                        	        <div class="col-md-10">
															...
															<div class="col-sm-6">
                                                        	    <div class="form-group">
                                                        	        ...
                                                        	        <div class="col-md-10">
                                                        	            ...
                                                        	            <?if(!empty($Foto)){?>
                                                        	            <a href="CertificadoDureza/<?=$Foto?>" target="_blank">(Ver foto)</a>
                                                        	            <?}?>
                                                        	        </div>
                                                        	    </div>
															</div>
														...
														<div id="One" style="display:none;" class="row">
															...
															<div class="col-md-6">
																	<table class="table table-hover table-condensed">
																		...
																		<tr>
																			<td rowspan="2"><input type="text" class="form-control text-center" id="Req1" name="Req1" value="<?=$Req1?>" style="max-width:90px;min-height:63px;font-size:20px;" onchange="Requerida();Total();" onKeyPress='return isNumberKeys(event);'></td>
																			<td>
																			  <table>
																				<tr>
																				  <td>
																				  	<div class="input-group">
																				  		...
																				  		<input type="text" class="form-control text-center" id="Req2" name="Req2" value="<?=$Req2?>" style="max-width:60px;min-height:31.5px;font-size:15px;" onchange="Requerida();Total();" onKeyPress='return isNumberKeys(event);'>
																				 	</div>
																				  </td>
																				</tr>
																				<tr>
																				  <td>
																				  	<div class="input-group">
																				  		<span class="input-group-addon" style="font-size:15px;"><strong>&nbsp;—</strong></span>
																				  		<input type="text" class="form-control text-center" id="Req3" name="Req3" value="<?=$Req3?>" style="max-width:60px;min-height:31.5px;font-size:15px;" onchange="Requerida();Total();" onKeyPress='return isNumberKeys(event);'>
																				 	</div>
																				  </td>
																				</tr>
																			  </table>
																			...
																			<td>
																			  <table>
																				<tr>
																				  <td>
																				  	<input type="text" class="form-control text-center" id="Req4" name="Req4" value="<?=$Req4?>" style="max-width:90px;min-height:31.5px;font-size:15px;" readonly>
																				  </td>
																				</tr>
																				<tr>
																				  <td>
																				  	<input type="text" class="form-control text-center" id="Req5" name="Req5" value="<?=$Req5?>" style="max-width:90px;min-height:31.5px;font-size:15px;" readonly>
																				  </td>
																				</tr>
																			  </table>
																			</td>
																			<td rowspan="2"><input type="text" class="form-control text-center" id="Req6" name="Req6" value="<?=$Req6?>" style="min-width:90px;min-height:63px;font-size:20px;" onclick="Requerida();" onchange="javascript:this.value=this.value.toUpperCase();Total();" readonly></td>
																		</tr>
																	</table>
															</div>
															<div class="col-md-5">
																	<table class="table table-hover table-condensed">
																		...
																		<tr>
																			<td rowspan="2" width="33%"><input type="text" id="Obt1" name="Obt1" value="<?=$Obt1?>" class="form-control text-center" style="min-height:63px;font-size:20px;" readonly></td>
																			<td rowspan="2" width="34%"><input type="text" id="Obt3" name="Obt3" value="<?=$Obt3?>" class="form-control text-center" style="min-height:63px;font-size:20px;" readonly></td>
																			<td rowspan="2" width="33%">
																				<div class="input-group">
																				<span class="input-group-addon" style="font-size:20px;"><strong>±</strong></span>
																				<input id="Obt2" name="Obt2" type="text" value="<?=$Obt2?>" class="form-control text-center" style="min-height:63px;font-size:20px;" readonly>
																				</div>
																			</td>
																		</tr>
																	</table>
															...
															<div class="col-md-6">
																<table style="background-color:#E6E6FA;" class="table table-condensed">
																	<tr>
																		...
																		<td><input type="text" class="form-control" id="Resultado" name="Resultado" value="<?=$Resultado?>" style="font-size:20px;min-height:50px;"  readonly></input></td>
																	</tr>
																</table>
															</div>
														</div>
		...
		FilasDerecha+="<tr><td class='text-center'><input type='text' id='Rain' name='Rain' value='<?=$Rain?>' class='form-control text-center' style='background-color:#99FF99;' readonly></td></tr>";
		...
		Desviacion+="<tr><td class='text-center'><input type='text' id='Desviacion' name='Desviacion' value='<?=$Desviacion?>' class='form-control text-center' style='background-color:#99FF99;' readonly></td></tr>";
		...
		//Función para cargar los values
		function Values(){
		//Insertando los valores principales (Vlr)
		<?
		$queryDD 		="SELECT * FROM CertificadoDurezaItems WHERE Idcertificado='$Id'";
        $resultDD 		=mysql_query($queryDD,$id);
        while ($rowDD 	=mysql_fetch_array($resultDD)){
        $NombreITEM 	=$rowDD["Nombre"];
        $ValorITEM 		=$rowDD["Valor"];

      	?>
      	$('#Vlr'+<?=$NombreITEM?>).val(<?=$ValorITEM?>);
      	<?
        }
		?>
		//Fin insersión de valores principales

		//Insertando los valores de la derecha y desviaciones
		<?
		$queryQQ 		="SELECT * FROM CertificadoDurezaItem1 WHERE Idcertificado='$Id'";
        $resultQQ 		=mysql_query($queryQQ,$id);
        while ($rowQQ 	=mysql_fetch_array($resultQQ)){
        $NombreITE  	=$rowQQ["Nombre"];
        $DerechoITEM 	=$rowQQ["Promedio"];
        $DesITEM 		=$rowQQ["Desviacion"];

      	?>
      	$('#Derecho'+<?=$NombreITE?>).val(<?=$DerechoITEM?>);
      	$('#Desv'+<?=$NombreITE?>).val(<?=$DesITEM?>);
      	<?
        }
		?>
		//Fin de la inserción de insertar los valores de la derecha y desviaciones

		//Insertando los promedios de abajo
		<?
		$query88 		="SELECT * FROM CertificadoDurezaItem2 WHERE Idcertificado='$Id'";
        $result88 		=mysql_query($query88,$id);
        while ($row88 	=mysql_fetch_array($result88)){
        $NombreIT  	=$row88["Nombre"];
        $PromITE 	=$row88["Promedio"];

      	?>
      	$('#Prom'+<?=$NombreIT?>).val(<?=$PromITE?>);
      	<?
        }
		?>
		//Fin insersión promedios de abajo

		};
		//Fin función para cargar los values
		</script>
