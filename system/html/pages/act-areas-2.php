...
include("../../includes/conexion.php");
                    ...
                    $queryped			="SELECT * FROM Areas WHERE Id = '$Idt'";
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												<form class="form-horizontal form-validate" role="form" method="post" action="act-areas-3.php" novalidate>
                                                ...
                                                <input name="Id"  id="Id" type="hidden" value="<?=$Idt?>">
													...
													<div class="form-group">
														<div class="col-lg-11 col-md-10 col-sm-9">
                                                            ...
                                                            <input name="Volver" type="button" class="btn btn-warning" value="Volver"  title="Volver atrás" onClick="location.href='<?=$_SESSION['anterior']?>'">
														</div>
													</div>
