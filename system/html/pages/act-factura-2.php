...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
		...
		$query			="SELECT* FROM Facturas where Id = '$Idfact'" ;
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-factura-3.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
											  ...
											  <div class="row">   
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class='input-group date' id='demo-date-start'>
                                                                        <input name="Fechaf" type="text" required class="form-control" id="Fechaf" value="<?=$Fechaf?>"/>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class='input-group date' id='demo-date-end'>
                                                                        <input name="Fechau" type="text" required class="form-control" id="Fechau" value="<?=$Fechau?>"/>
                                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
													...
													<div class="form-group">
														...
														?>
                                                            ...
                                                            <button type="button" id="enviar" class="btn btn-success" data-toggle="modal" data-target="#formModal">Finalizar Factura</button>


                                                            
                                                          <button type="button" id="enviar" class="btn btn-support5" onClick="location.href='act-factura.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'">Volver</button> 
					...
					<div class="modal-dialog">
						<div class="modal-content">
						  <div class="modal-header">
								...
								<h4 class="modal-title" id="formModalLabel">Finalizar Factura</h4>
							</div>
	
                            <form action="act-factura-4.php" method="post" enctype="multipart/form-data" name="form1" class="form-horizontal form-validate" id="form1" novalidate role="form">
                              <input name="Id" id="Id" type="hidden" value="<?=$Idfact?>">
                              <span class="col-lg-2 col-md-4 col-sm-6">
                              <input name="Idmenu" type="hidden" id="Idmenu" value="<?=$_REQUEST["Idmenu"]?>">
                              <input name="Idsubmenu" type="hidden" id="Idsubmenu" value="<?=$_REQUEST["Idsubmenu"]?>">
                              <input name="Idopcmenu" type="hidden" id="Idopcmenu" value="<?=$_REQUEST["Idopcmenu"]?>">
                              <input name="Clase" type="hidden" id="Clase" value="<?=$Nombreser?>">
                              <input name="Totaliza" type="hidden" id="Totaliza" value="<?=$GRANTOTALIVA?>">
                              </span>
								<div class="modal-body">
									...
									<div class="form-group">
										<div class="col-lg-12">
											<label for="Forma" class="control-label">Forma de Pago</label>
										</div>
								  </div>
									<div class="form-group">
										<div class="col-lg-12">
									...
									<div class="form-group">
										<div class="col-lg-12">
											<label for="Nrocheque" class="control-label">Nro. Cheque</label>
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-12">
																<input name="Nrocheque" type="text"  required class="form-control" id="Nrocheque"  placeholder="Nro de Cheque" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Nombreaprueba?>">
										</div>
									</div>
                                    </div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<label for="Rte" class="control-label">Rte Fuente</label>
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-12">
																<input type="text" class="form-control" placeholder="Rte Fuente" required name="Rte" id="Rte" value="<?=$Rte?>"/>
                                        </div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<label for="Ica" class="control-label">Rte Ica</label>
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-12">
																<input type="text" class="form-control" required placeholder="Rte Ica" name="Ica" id="Ica" value="<?=$Rte?>"/>
                                        </div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<label for="Rteiva" class="control-label">Rte Iva</label>
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-12">
																<input type="text" class="form-control" required placeholder="Rte Iva" name="Rteiva" id="Rteiva" value="<?=$Rteiva?>"/>
                                        </div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<label for="Rteiva" class="control-label">Recibo</label>
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-12">
																<input type="text" class="form-control" required placeholder="Recibo de Caja" name="Recibo" id="Recibo" value="<?=$Recibo?>"/>
                                        </div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<label for="Rteiva" class="control-label">Nro. Serv</label>
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-12">
																<input type="text" class="form-control" required placeholder="Nro. de Servicios" name="Servicios" id="Servicios" value="<?=$Cont?>"/>
                                        </div>
									</div>
