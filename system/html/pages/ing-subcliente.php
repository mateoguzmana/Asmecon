								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Informacion del Sub Cliente</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate"   enctype="multipart/form-data"role="form" method="post" action="ing-subcliente-2.php" novalidate>
                                                        <?
														}
														else
														{
															...
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                        <select name="Cliente" id="Cliente" class="form-control select2-list" data-placeholder="Seleccione un Cliente" required>
                                                                            ...
                                                                            <option value="" selected>Cliente Principal</option>
                                        <?
