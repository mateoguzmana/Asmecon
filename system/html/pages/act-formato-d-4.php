...
<?
														...
														{
?>
												<form class="form-horizontal form-validate" role="form" method="get" action="add-formato-d-3.php" id="form1" name="form1" enctype="multipart/form-data" autocomplete="off" novalidate>
                                                        <?
														}
														elseif($Envia == 1 && $Paso == 0)
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-formato-d-4.php" id="form1" name="form1" enctype="multipart/form-data" autocomplete="off" novalidate>
                                                        <?
														}
														elseif($Envia == 1 && $Paso == 1)
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-formato-d-5.php" id="form1" name="form1" enctype="multipart/form-data" autocomplete="off" novalidate>
                                                        <?
														}
														?>
										...
										<table style="background-color:white;" class="table table-condensed table-hover">
											...
											<thead>
												...
												?>
													<th><input type="text" name="Vlr<?=$i?>" id="Vlr<?=$i?>" class="form-control" placeholder="" value="<?=$Valor?>" onKeyPress="return isNumberKeys(event);" required style="width:99%; font-size:11px; background-color:#EFEFEF; border:0px; text-align:center;" onkeypress="" onkeydown="" onchange=""></th>
                                                <?
												}
												?>
                                               </tr> 
                                                            ...
                                                            <td style="background-color:#E3E4E0"><?=$a?></td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <table width="100%" border="0">
                                                                      <tr>
                                                                        <td width="50%"><input type="text" name="Itm<?=$a?><?=$o?>" id="Itm<?=$a?><?=$o?>" class="form-control" placeholder="" value="<?=$ValorF?>" onKeyPress="return isNumberKeys(event);" style="font-size:9.5px; background-color: #EFEDBA; border:0px; text-align:center;min-width:100px;" onchange="Individual(<?=$a?><?=$o?>,<?=$o?>,<?=$o?>,<?=$o?>,<?=$a?><?=$o?>);"></td>
                                                                        <td width="50%" id="Ras<?=$a?><?=$o?>" style="text-align:center;font-size:8.7px;min-width:100px;"><?=$ResultadoF?></td>
                                                                      </tr>
                                                                    </table>
                                                                    </td>
...
?>
                                                            ...
                                                            <td style="background-color: #FEABB1">%</td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <table width="100%" border="0">
                                                                      <tr>
                                                                        <td width="50%" id="Valres<?=$e?>" style="text-align:center;font-size:12px;min-width:100px;"><?=$ValorE?></td>
                                                                        <td width="50%" id="Res<?=$e?>" style="text-align:center;font-size:9px;min-width:100px;"><?=$ResultadoR?></td>
                                                                      </tr>
                                                                    </table>
                                                                    </td>
...
?>
													...
													<div style="text-align:left;">
														...
														?>
															...
															<button type="button" class="btn btn-support5">CALCULAR</button>&nbsp;
															<button type="button" onclick="window.location='ing-cert-dureza.php?Idmenu=10&Idsubmenu=42&Idopcmenu=66&C=<?=$Cliente?>&F=<?=$Fecha?>&O=<?=$Idord?>';" class="btn btn-support3">Certificado Dureza</button>
                                                        <?
														}
														else
														{
...
?>
		...
		<!-- AJAX PARA MOSTRAR EL RESULTADO...-->
		<!--<script type="text/javascript">
		function Respuesta(){
