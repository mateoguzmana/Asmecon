...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$LineaMenuS			=$NombreTITMEN;
						...
						$queryTITMER		="SELECT* FROM Recepcion WHERE Cotizacion = '$Id'" ;
						$resultTITMER		=mysql_query($queryTITMER, $id);
						
						while($rowTITMER	=mysql_fetch_array($resultTITMER))
						{
						$Idrip				=$rowTITMER["Id"];
						}
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-orden-3.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
...
?>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Direccion" id="Direccion" class="form-control" placeholder="Dirección del Cliente" value="<?=$Dirclien?>" readonly style="background-color:#CCC">
																</div>
															</div>
														</div>
                                              ...
                                              <div class="row">  
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Telefono" id="Telefono" class="form-control" placeholder="Teléfono del Cliente" value="<?=$Telefonoclien?>" readonly style="background-color:#CCC">
																</div>
															</div>
														</div>
														...
														<div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input type="text" class="form-control" name="Email" id="Email" value ="<?=$Emailclien?>" placeholder="Email del Cliente" readonly style="background-color:#CCC">
                                                                </div>
                                                            </div>
														</div>
											  ...
											  <div class="row">   
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class='input-group date' id='demo-date-start'>
                                                                        <input type="text" class="form-control" required name="Fechaord" id="Fechaord"/>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class='input-group date' id='demo-date-end'>
                                                                        <input type="text" class="form-control" required name="Fechaentrega" id="Fechaentrega"/>
                                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                            </div>
														...
														<div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input name="Ordencte" type="text"  required class="form-control" id="Ordencte"  placeholder="Nro. Orden del cliente" onChange="javascript:this.value=this.value.toUpperCase();" >
                                                                </div>
                                                            </div>
														</div>
														...
														<div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="col-lg-2 col-md-4 col-sm-6">
                                                                    <label for="Rip" class="control-label">Nro. Rip</label>
                                                                </div>
                                                                <div class="col-md-10">
                                                                    <input name="Rip" type="text"  class="form-control" id="Rip" readonly onChange="javascript:this.value=this.value.toUpperCase();"  value="<?=$Idrip?>">
                                                                </div>
                                                            </div>
														</div>                                   
...
<br>
													...
													<div class="form-group">
														...
														?>
                                                          ...
                                                          <button type="button" id="enviar" class="btn btn-support5" onClick="location.href='add-orden.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'">Volver</button> 
                                                        <?
														}
														?> 
														</div>
