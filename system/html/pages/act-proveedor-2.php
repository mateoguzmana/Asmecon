									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												...
												<form class="form-horizontal form-validate" enctype="multipart/form-data"  role="form" method="post" action="act-proveedor-3.php" novalidate>
													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-lg-2 col-md-4 col-sm-6">
                                                                <? if(!empty($Rut)){?><a href="proveedores/<?=$Rut?>" target="_blank">(Ver Rut)</a><? }?>
																</div>
																<div class="col-lg-10 col-md-8 col-sm-6">
																</div>
															</div>
