...
$queryka		=	"UPDATE Informacion set Nombre = '$Nombre', Email = '$Email', Dir = '$Dir', Telefono = '$Telefono', Ciudad = '$Ciudad', Codigo = '$Codigo', Telefono = '$Telefono', Pais = '$Pais', Celular = '$Celular', Urlseguimiento = '$Urlseguimiento', Banco = '$Banco', Tipocuenta = '$Tipocuenta', Nrocuenta = '$Nrocuenta', Nombrecuenta = '$Nombrecuenta', Nit = '$Nit', Fax = '$Fax'  Where Id='$Id'";
...
(copy($archivo1, "logo/".$foto1));
	...
	$resizeObj -> resizeImage(450, 250, 'auto');
