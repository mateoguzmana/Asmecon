...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-asigna-2.php" novalidate>
                                                        <?
														}
														else
														{
												  ...
												  <div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" class="form-control dollar-mask" name="Valor" id="Valor"  placeholder="Valor">
																</div>
															</div>
														</div>
													</div>
