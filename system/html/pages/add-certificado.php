								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Asignar Certificado a Servicio</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
function validar()
{
    ...
    else
	{
        ...
        return false;
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-certificado-2.php"  name="form2" id="form2" novalidate>
                                                        <?
														}
														else
														{
													...
													<div class="row">
															<div class="form-group">
                                                        	  ...
                                                        	  <div class="col-lg-11 col-md-10 col-sm-9">
																<label for="Nombre" class="control-label">Servicios</label>
															  </div>
 ...
 <?
		...
		$queryS			="SELECT COUNT(*) AS TOTAL FROM Certificado where Idservicio = '$Id' " ;
