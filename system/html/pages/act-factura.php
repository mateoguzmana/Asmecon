...
?>
			...
			<div id="content">
				...
				$query			="SELECT* FROM Facturas ORDER BY Id" ;
				...
				$query1			="SELECT* FROM Cotizaciones where Id = '$Idcotiz'" ;
				...
				$query2			="SELECT* FROM Clientes where Cedula = '$Nit'" ;
				...
				else
				{
					$Estado	=	"ANULADA";		
												...
												<tr class="gradeA">
                                                    ...
                                                    <td><?=$Nombre?></td>
													<td>
                                                    <button type="button" class="btn btn-primary btn-outline btn-xs" style="width:120px;"><?=$Estado?></button>
													...
													<td class="text-right">
														...
														?>  
                                                        <?
                                                        if($Estado == 'SIN CANCELAR')
                                                        {
														?>                                                
														<input name="Procesar" type="button" class="btn btn-primary" value="MODIFICAR"  onClick="location.href='act-factura-2.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        

                                                        <input name="Procesar" type="button" class="btn btn-danger" value="ANULAR"  data-toggle="modal" data-target="#textModal<?=$Id?>">
														<?
														}
														?>
														...
														?> 
                                                        <input name="IMPRIMIR" type="button" class="btn btn-support5" value="IMPRIMIR"  onclick="window.open('print-fact.php?Id=<?=$Id?>')"  data-placement="top">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title" id="textModalLabel">Factura Nro. <?=$Id?></h4>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-success" onclick="location.href='delete-fact.php?Id=<?=$Id?>&Idorden=<?=$Idorden?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'">Confirmar</button>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div><!-- /.modal-dialog -->
                                                </div><!-- /.modal -->
