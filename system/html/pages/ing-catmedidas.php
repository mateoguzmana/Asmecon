...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="ing-catmedidas-2.php" novalidate>
                                                        <?
														}
														else
														{
																...
																<div class="col-sm-12">
																	<label for="Linea" class="control-label">Linea</label>
																	 <select name="Linea" id="Linea" class="form-control select2-list" data-placeholder="Seleccione Categoria" required>
																		...
																		<?
                                                                        $queryNN		="SELECT * FROM Areas where Muestra = 0 order by Nombre";
