...
?>
			...
			$query			="SELECT* FROM Cotizaciones WHERE Estado = 'SI' and Orden = '' ORDER BY Id Desc" ;
				...
				$bto	=	'SELECCIONAR';	
												...
												<tr class="gradeA">
													...
													<td class="text-right">
														...
														{
														?>                                                    
														<input name="Procesar" type="button" class="btn btn-primary" value="<?=$bto?>"  onClick="location.href='add-orden-2.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        <?
														}
														?> 
