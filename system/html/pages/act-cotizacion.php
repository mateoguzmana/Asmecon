				...
				$class  ='class="btn btn-primary"';
												...
												<tr class="gradeA">
													...
													<td class="text-right">
														...
														{
														?>                                                    
														<input name="Procesar" type="button" <?=$class?> value="<?=$bto?>" style="width:100px;" onClick="location.href='act-cotizacion-2.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        <?
														}
														?> 
														...
														{
														?>  
													<input name="IMPRIMIR" type="button" class="btn btn-support5" value=" IMPRIMIR " style="width:100px;" onclick="window.open('print-cotiz.php?Id=<?=$Id?>')"  data-placement="top">
