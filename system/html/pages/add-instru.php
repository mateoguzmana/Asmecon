								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Asignar Tipo de Instrumento a Servicio</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
function validar()
{
    ...
    else
	{
        ...
        return false;
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-instru-2.php"  name="form2" id="form2" novalidate>
                                                        <?
														}
														else
														{
 ...
 <?
		...
		$queryS			="SELECT COUNT(*) AS TOTAL FROM Tipoinstrumento where Idservicio = '$Id' " ;
