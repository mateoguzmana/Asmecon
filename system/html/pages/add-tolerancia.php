								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Crear Tolerancia</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-tolerancia-2.php" novalidate>
                                                        <?
														}
														else
														{
								...
								<select name="Tipo" id="Tipo" class="form-control select2-list" data-placeholder="Seleccione un Tipo" required>

                            
                                    <option value="" selected>Seleccione un Tipo de Procedimiento</option>
<?
			...
			$IdP					= $rowP["Id"];
?> 
                                    <option value="<?=$IdP?>"><?=$NombreP?></option>
<?
			}
?>
