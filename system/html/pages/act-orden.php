				...
				$bto	=	'REVISAR';	
												...
												<tr class="gradeA">
													...
													<td class="text-right">
														...
														{
														?>                                                    
														<input name="Procesar" type="button" class="btn btn-primary" value="<?=$bto?>"  onClick="location.href='act-orden-2.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        
                                                        <?
                                                        if($Factura == '000000')
                                                        {
														?>
                                                        <input name="Procesar" type="button" class="btn btn-danger" value="ELIMINAR"  data-toggle="modal" data-target="#textModal<?=$Id?>">
														<?
														}
														?>
														...
														?> 
                                                        <input name="IMPRIMIR" type="button" class="btn btn-support5" value=" IMPRIMIR "  onclick="window.open('print-orden.php?Id=<?=$Id?>')"  data-placement="top">
