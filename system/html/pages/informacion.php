												...
												<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                               ...
                                                               <input name="Fax" type="text" class="form-control" id="Fax" placeholder="Ingrese un Fax" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Fax?>" required data-rule-minlength="3">
																</div>
															</div>
														</div>
													...
													<div class="row">
                                                     ...
                                                     <div class="col-lg-2 col-md-4 col-sm-6">
                                                                ...
                                                                <div class="col-lg-10 col-md-8 col-sm-6">
                                                                    <img src="logo/<?=$Logo?>" width="151" height="67"><br>
