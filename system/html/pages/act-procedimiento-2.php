...
include("../../includes/conexion.php");
                    ...
                    $queryped			="SELECT* FROM Tipoproced where Id = '$Idt'";
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Modificar tipo de Procedimiento</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												<form class="form-horizontal form-validate" role="form" method="post" action="act-procedimiento-3.php" novalidate>
