...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-cotizacion-3.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
...
?>
													...
													<div class="form-group">
														...
														?>
                                                        	...
                                                        	<button type="button" id="enviar" class="btn btn-support5" onClick="location.href='ing-cotizacion-3.php?Idserv=<?=$Idserv?>&Idcliente=<?=$Idcli?>&Idcotiz=<?=$Id?>&Id=<?=$Id?>&Idmenu=3&Idmenu=3&Idsubmenu=24&Idopcmenu=34'">Reutilizar</button>
                                                        	<? } ?>
                                                        <?	
														}
														?> 
					...
					<div class="modal-dialog">
						<div class="modal-content">
						  <div class="modal-header">
                            ...
                            <form action="act-cotizacion-4.php" method="post" enctype="multipart/form-data" name="form2" class="form-horizontal form-validate" id="form2" novalidate role="form">
                              <input name="Id" id="Id" type="hidden" value="<?=$Id?>">
