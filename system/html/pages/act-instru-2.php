...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
		...
		$query			="SELECT* FROM Tipoinstrumento where Id = '$Id'" ;
								...
								<div class="box style-transparent">
									...
									<div class="box-head">
										<ul class="nav nav-tabs tabs-transparent" data-toggle="tabs">
											<li class="active"><a href="#editDetails"><i class="fa fa-edit"></i> Asignar Tipo Instrumento a Servicio</a></li>
										</ul>
									</div>
									<!-- END PROFILE TABS -->
...
function validar()
{
    ...
    else
	{
        ...
        return false;
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-instru-3.php"  name="form2" id="form2" novalidate>
                                                        <?
														}
														else
														{
															...
															<div class="form-group">
                                                              <div class="col-lg-1 col-md-2 col-sm-3">
                                                                ...
                                                                <div class="col-lg-11 col-md-10 col-sm-9">
																	<input name="Nombre" type="text" required class="form-control" id="Nombre" placeholder="Ingrese un Nombre" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$NombreD?>" data-rule-minlength="3">
																</div>
															</div>
 ...
 <?
		...
		$queryS			="SELECT COUNT(*) AS TOTAL FROM Tipoinstrumento where Idservicio = '$Id' and Nombre = '$NombreD' and Activo = 0" ;
