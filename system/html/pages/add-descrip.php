...
function validar()
{
    ...
    else
	{
        ...
        return false;
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-descrip-2.php"  name="form2" id="form2" novalidate>
                                                        <?
														}
														else
														{
 ...
 <?
		...
		$queryS			="SELECT COUNT(*) AS TOTAL FROM Descripcion where Idservicio = '$Id' " ;
