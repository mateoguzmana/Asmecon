...
$query		="UPDATE Cotizaciones set Cliente = '$Nombrecli', Nit = '$Nit', Telefono = '$Telefono', Direccion = '$Direccion', Ciudad = '$Ciudad', Email = '$Email', Fax = '$Fax', Servicio = '$Nombreser', Idserv = '$Idserv', Asunto = '$Asunto', Informacion = '$Informacion', Alcance = '$Alcance', Condiciones1 = '$Informe', Condiciones2 = '$Lugar', Condiciones3 = '$Transporte', Condiciones4 = '$Embalaje', Condiciones5 = '$Validez', Condiciones6 = '$Forma', Condiciones7 = '$Entrega', Nota = '$Descripcion' Where Id='$Id'";
$result		=mysql_query($query, $id);


$SQL="Delete From Cotizacionesitem Where Idcotiz='$Id'";
mysql_query($SQL);
