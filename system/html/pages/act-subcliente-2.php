...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
					...
					$IdUS				=$_REQUEST['Id']; 
					 ...
					 $queryUSERS		="SELECT* FROM Clientesde where Id = '$IdUS'";
					 ...
					 While($rowUSERS	=mysql_fetch_array($resultUSERS))
					 {
						...
						$Rut				=$rowUSERS["Rut"];
													...
													$queryUSERz			="SELECT* FROM Clientes where Id = '$Idcliente' Order by Nombre";
													$resultUSERz		=mysql_query($queryUSERz, $id);
													
													While($rowUSERz		=mysql_fetch_array($resultUSERz))
													{
													$NombreUSERz		=$rowUSERz["Nombre"];
													}
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												...
												<form class="form-horizontal form-validate" enctype="multipart/form-data"  role="form" method="post" action="act-subcliente-3.php" novalidate>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                        <select name="Cliente" id="Cliente" class="form-control select2-list" data-placeholder="Seleccione un Cliente" required>
                                        
                                                                    
                                                                            <option value="<?=$Idcliente?>" selected><?=$NombreUSERz?></option>
                                        <?
                                                    $query					="SELECT* FROM Clientes where Muestra = 0  ORDER BY Nombre" ;
                                        ...
                                        ?>
                                                    ...
                                                    <div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<div class="col-lg-10 col-md-8 col-sm-6">
                                                                	<input type="text" name="Retencion" id="Retencion" class="form-control" placeholder="% de Retención" value="<?=$Retencion?>" onKeyPress="return isNumberKey(event);" required>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																<div class="col-lg-2 col-md-4 col-sm-6">
                                                                <? if(!empty($Rut)){?><a href="clientes/<?=$Rut?>" target="_blank">(Ver Rut)</a><? }?>
																</div>
																<div class="col-lg-10 col-md-8 col-sm-6">
																</div>
															</div>
