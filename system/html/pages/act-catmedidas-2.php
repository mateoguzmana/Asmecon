...
include("../../includes/conexion.php");
                    ...
                    $queryped			="SELECT * FROM CatMediciones WHERE Id = '$Idt'";
					...
					$queryKK 			="SELECT * FROM Areas WHERE Id='$Linea'";
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												<form class="form-horizontal form-validate" role="form" method="post" action="act-catmedidas-3.php" novalidate>
															...
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="Linea" class="control-label">Linea</label>
																	 <select name="Linea" id="Linea" class="form-control select2-list" data-placeholder="Seleccione Categoria" required>
            
                                                                        <option value="<?=$IdKK?>" selected><?=$NombreKK?></option>

																		<?
                                                                        $queryNN		="SELECT * FROM Areas where Muestra = 0 and Id <> '$Linea' order by Nombre";
