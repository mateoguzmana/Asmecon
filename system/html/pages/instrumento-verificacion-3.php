...
$sql="UPDATE Verificacionins SET Instrumento='$Instrumento',Fecha='$Fecha',Proxima='$Proxima',Frecuencia='$Frecuencia',
Accion='$Accion',Actividad='$Actividad',Observacion='$Observacion',Responsable='$Responsable' WHERE Id='$Id'";
mysql_query($sql);
