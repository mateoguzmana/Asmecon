...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="add-exporadica-2.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
														...
														<div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione un Servicio" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-exporadica.php?Idserv=<?=$Idserv?>&Idcliente=<?=$Idcliente?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreser?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-exporadica.php" selected>Seleccione un Servicio</option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="add-exporadica.php?Idserv=<?=$IdTIS?>&Idcliente=<?=$Idcliente?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIS?></option>
																		<?
																		}
																		?>
															...
															<div class="form-group">
															  <div class="col-lg-2 col-md-4 col-sm-6">
                                                                ...
                                                                <select name="jumpMenu" id="jumpMenu" class="form-control" onChange="MM_jumpMenu('parent',this,0)"required  data-placeholder="Seleccione el Cliente" style="background-color:#CCC">
																		...
																		{
																		?>
                                                                  <option value="add-exporadica.php?Idserv=<?=$Idserv?>&Idcliente=<?=$Idcliente?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>" selected><?=$Nombreclien?></option>
                                                                        <?
																		}
																		else
																		{
																		?>
                                                                        <option value="add-exporadica.php?Idserv=<?=$Idserv?>" selected>Seleccione el Cliente</option>
                                                                        <?
																		}
                                                                        ...
                                                                        ?>
                                                                        <option value="add-exporadica.php?Idserv=<?=$Idserv?>&Idcliente=<?=$IdTIP?>&Idmenu=<?=$Idmenux?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>"><?=$NombreTIP?></option>
																		<?
																		}
																		?>
