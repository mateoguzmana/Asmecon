...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
		...
		$query			="SELECT* FROM Documentacion where Id = '$Id'" ;
...
function validar()
{
    ...
    else
	{
        ...
        return false;
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-documento-3.php"  name="form2" id="form2" novalidate>
                                                        <?
														}
														else
														{
 ...
 <?
		...
		$queryS			="SELECT COUNT(*) AS TOTAL FROM Documentacion where Idservicio = '$Id' and Nombre = '$NombreD' and Activo = 0" ;
