...
?>
			...
			$query			="SELECT* FROM Recepcion ORDER BY Id Desc" ;
			...
			$Fecha			=$row["Fecha"];
				...
				$class  =   'class="btn btn-primary"';	
					...
					$queryS					="SELECT* FROM Servicios Where Id = '$Idservicio'" ;
					...
					$NombreS				= ($rowS["Nombre"]);
												...
												<tr class="gradeA">
                                                    ...
                                                    <td><?=$NombreS?></td>
													<td><?=$Nombre?></td>
                                                    <td><button type="button" class="btn btn-primary btn-outline btn-xs" style="width:90px;"><?=$Estado?></button></td>
                                                    <td><?=$Fecha?></td>
													<td class="text-right">
														...
														{
														?>                                                    
														<input name="Procesar" type="button"  value="<?=$bto?>" <?=$class?> onClick="location.href='act-recepcion-2.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        <?
														}
														?> 
														...
														{
														?>  
													<input name="IMPRIMIR" type="button" class="btn btn-support5" value=" IMPRIMIR "  onclick="window.open('print-ingreso.php?Id=<?=$Id?>')"  data-placement="top">
