...
include("../../includes/conexion.php");
                    ...
                    $queryped			="SELECT* FROM Tipoprocedopc where Id = '$Idt'";
						...
						<div class="row">
							<div class="col-lg-12">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
												<form class="form-horizontal form-validate" role="form" method="post" action="act-tolerancia-3.php" novalidate>
								...
								<select name="Tipo" id="Tipo" class="form-control select2-list" data-placeholder="Seleccione un Tipo" required>
                                    ...
                                    <option value="<?=$Idtipoproc?>" selected><?=$NombreP?></option>
<?
