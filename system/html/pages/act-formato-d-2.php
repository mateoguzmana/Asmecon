...
include("../../includes/conexion.php");
					...
					$queryTITMEN		="SELECT * FROM Clientesde WHERE Nombre = '$Subcliente'" ;
					$resultTITMEN		=mysql_query($queryTITMEN, $id);
					
					While($rowTITMEN	=mysql_fetch_array($resultTITMEN))
					{
					$NombreClide		=$rowTITMEN["Nombre"];
					}
					...
					$query				="SELECT Id FROM Clientes where Nombre = '$Cliente'" ;
					$result				=mysql_query($query, $id);
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-formato-d-3.php" id="form1" name="form1" enctype="multipart/form-data" novalidate>
                                                        <?
														}
														else
														{
...
<div class="section-body">
						<div class="row">
							<div class="col-lg-12">
											  ...
											  <div class="row">  
															...
															<div class="form-group">
                                                                ...
                                                                <div class="col-lg-10 col-md-8 col-sm-6">
                                                                    <div class='input-group date' id='demo-date-inline'>
                                                                        <input name="Fecha" type="text" required class="form-control" id="Fecha" value="<?=$Fecha?>"/>
											     ...
											     <div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <div class="col-lg-10 col-md-8 col-sm-6">
                                                                        <input name="Descripcion" type="text" required class="form-control" id="Descripcion" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Descripcion?>"/>
                                                                </div>
															</div>
											     </div>
								...
								<select name="Proveedor" id="Proveedor" class="form-control select2-list" data-placeholder="Seleccione una Opción" readonly>
...
?>
															...
															<div class="form-group">
                                                                ...
                                                                <div class="col-lg-10 col-md-8 col-sm-6">
                                                                       <!-- <input name="Sub_cliente" type="text" required class="form-control" id="Sub_cliente" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Subcliente?>"/> -->
                                                                        <select name="Sub_cliente" id="Sub_cliente" class="form-control select2-list" data-placeholder="Seleccione una Opción" readonly>

                            
                                    <option value="<?=$Subcliente?>" selected><?=$NombreClide?></option>
<?
...
?>
											     ...
											     <div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <div class="col-lg-10 col-md-8 col-sm-6">
                                                                        <input name="Cantidad" type="text" required class="form-control" id="Cantidad" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Cantidad?>"/>
                                                                </div>
															</div>
											     </div>  
											     ...
											     <div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <div class="col-lg-10 col-md-8 col-sm-6">
                                                                        <input name="Dureza" type="text" required class="form-control" id="Dureza" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Dureza?>"/>
                                                                </div>
															</div>
											     </div>  
											     ...
											     <div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <div class="col-lg-10 col-md-8 col-sm-6">
                                                                        <input name="Obtenida" type="text" required class="form-control" id="Obtenida" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Obtenida?>"/>
                                                                </div>
															</div>
											     </div>  
											     ...
											     <div class="col-sm-6">
															<div class="form-group">
                                                                ...
                                                                <div class="col-lg-10 col-md-8 col-sm-6">
                                                                        <input name="Material" type="text" required class="form-control" id="Material" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Material?>"/>
                                                                </div>
															</div>
											     </div> 
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="editDetails">
											<div class="box-body style-white">
											  <div class="form-group">
												  	<div class="col-sm-12">
																	<label for="Descripcion" class="control-label">Observaciones</label></br>
																	<label>&nbsp;</label>
