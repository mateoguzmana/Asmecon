...
$_SESSION['anterior']	=	$_SERVER['REQUEST_URI']; 
		...
		$Servicio		=$row["Servicio"];
						...
						$queryTITMER		="SELECT* FROM Recepcion WHERE Cotizacion = '$Idcotiz'" ;
...
?>
														...
														{
														?>
												<form class="form-horizontal form-validate" role="form" method="post" action="act-orden-3.php" id="form1" name="form1" novalidate>
                                                        <?
														}
														else
														{
											  ...
											  <div class="row">   
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class='input-group date' id='demo-date-start'>
                                                                        <input name="Fechaord" type="text" required class="form-control" id="Fechaord" value="<?=$Fechaord?>"/>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class='input-group date' id='demo-date-end'>
                                                                        <input name="Fechaentrega" type="text" required class="form-control" id="Fechaentrega" value="<?=$Fechaentrega?>"/>
                                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                                    </div>
                                                                </div>
                                                            </div>
														...
														<div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input name="Ordencte" type="text"  required class="form-control" id="Ordencte"  placeholder="Nro. Orden del cliente" onChange="javascript:this.value=this.value.toUpperCase();" value="<?=$Ordencte?>" >
                                                                </div>
                                                            </div>
														</div>
...
<br>
													...
													<div class="form-group">
														...
														?>
                                                          ...
                                                          <button type="button" id="enviar" class="btn btn-support5" onClick="location.href='act-orden.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'">Volver</button> 
                                                        <?
														}
														?> 
														</div>
