			...
			<div id="content">
				<section>
					<div class="section-header">
						<h2 class="text-standard"><i class="fa fa-fw fa-arrow-circle-right text-gray-light"></i> Instrumento <?=$Codigo?></h2>
					</div>
                                                            ...
                                                            <div class="modal-body"><?
                                                            	...
                                                            	<div class="row">
                                                            		...
                                                            		<a href="print-etiquetagra.php?Id=<?=$IdUS?>" style="text-decoration:none;" title="Imprimir etiqueta grande" target="_blank">
                                                            			<table class="table-responsive" style="width:100%;border:1px solid;text-align:center;" border="1">
																		<tr>
																		...
																		<tr>
																			<td colspan="2" style="font-size:24px;"><strong>Rango:</strong></td>
																			<td colspan="1" style="font-size:24px;"><?=$RangoIntervalo?></td>
																		</tr>
																		<tr>
																			<td colspan="2" style="font-size:24px;"><strong>Nº</strong></td>
                                                            		...
                                                            		<a href="print-etiquetamed.php?Id=<?=$IdUS?>" style="text-decoration:none;" title="Imprimir etiqueta mediana" target="_blank">
                                                            			<table class="table-responsive" style="border:1px solid;text-align:center;" border="1">
																		<tr>
                                                            		...
                                                            		<h4>Etiqueta pequeña <a href="print-etiquetamin.php?Id=<?=$IdUS?>" class="text-muted" style="text-decoration:none;" title="Impirmir etiqueta pequeña" target="_blank">(Vista previa)</a></h4>
                                                            			...
                                                            			<table class="table-responsive" style="border:1px solid;" border="1">
                                                            				<tr>
                                                            					<td width="35%"><img src="logo3.jpg" width="100%" height="80"></td>
                                                            					<td width="50%" style="font-size:40px;text-align:center;"><strong><?=$Codigo?></strong></td>
                                                            					<td width="15%"><?=$QR2?></td>
                                                            				</tr>
                                                            			</table>
                                                            			</a>
...
<!-- EMPIEZA PLAN DE VERIFICACIÓN-->
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                               	<h4>Plan de verificación <?=$IdPlan?></h4><br>
                                                               	<button type="button" id="botonListado" class="btn btn-support5" onclick="verTodo()">Ver todos</button>
																<button type="button" id="verTodo" class="btn btn-primary" onclick="mostrarIng();cargar(0)">Ingresar nuevo</button>
                                                            </div>
                                                            <div id="ingNuevoVeri" style="display:none;">
												<form class="form-horizontal form-validate" action="#" id="formVeri" role="form" method="post" novalidate>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Instrumento" class="form-control" placeholder="Instrumento"  value="<?=$IdUS?>" readonly onChange="javascript:this.value=this.value.toUpperCase();" required >
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<div class='input-group date' id='demo-date'>
																		<input type="text" class="form-control" required name="Fecha" id="FechaC"/>
																		<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
																	</div>
																</div>
															</div>
														...
														<div class="form-group">
															<div class="col-lg-10 col-md-8 col-sm-6">
																<div class='input-group date' id='demo-date-end'>
																		<input type="text" class="form-control" required name="Proxima" id="ProximaC"/>
																		<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
																	</div>
															</div>
															</div>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<select name="Frecuencia" id="FrecuenciaC" class="form-control" required>
																	<option id="OpcFre" value="" selected></option>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	...
																	<option value="" id="OpcAcc" selected></option>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Actividad" id="Actividad" class="form-control" placeholder="Actividad" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
														<div class="col-sm-6">
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Observacion" id="ObservacionC" class="form-control" placeholder="Observación" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
														<div class="col-sm-6">
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" class="form-control" id="ResponsableC" name="Responsable" placeholder="Responsable" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
                                                             </div> 
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
																<button type="submit" id="Ingress" class="btn btn-primary">Realizar Operación</button>
																<input type="button" id="ActBtn" value="Actualizar" style="display:none;" class="btn btn-primary" onclick="ActualizarV();">
                                                            </div>
                                                           </form>
                                                       </div>
                                                           	<div class="modal-body">
                                                           	<div class="row">
                                                           	<div style="display:none;" id="ListadoVeri">                                                  		                                                            <div class="col-sm-12">
	<div class="box box-bordered style-support5">
		<div class="box-head">
			<header><h4 class="text-light">Planes de<strong> verificación</strong></h4></header>
			<div class="tools">
		...
		<div class="box-body height-8 scroll style-white" style="overflow: hidden; width: auto; height:257px;">
		<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height:auto">
			
                    										<?
                    										$query44				="SELECT * FROM Verificacionins WHERE Instrumento='$IdUS' AND Muestra!=1 ORDER BY Id DESC";
															...
															$MuestraVER 			=$row44["Muestra"];
															$Contv++;
															?>
                     
            <div id="ContenedorV<?=$Contv?>">                                      	
                <div class="row">
                  	<div class="col-sm-4">
                  		<li><a onclick="cargar(<?=$IdACT?>);ShowAct();" title="Ver plan de verificación nro <?=$IdACT?>"  class="btn text-support5 link" style="font-size:14px;">Nro. <?=$IdACT?></a></li>
                  	</div>
                  	<div id="RespV<?=$Contv?>" class="col-sm-5">
                  		
                  	</div>
                  	<div class="col-sm-3">
                  		<button  title="Ver / Actualizar" onclick="cargar(<?=$IdACT?>);ShowAct();" class="btn btn-support5 btn-xs"><i class="fa fa-pencil"></i></button>
                  		<?if($MuestraVER!=2){?>
                  		<button id="FinV<?=$Contv?>"  title="Finalizar plan de verificación" onclick="FinalizarV(<?=$IdACT?>,<?=$Contv?>)" class="btn btn-primary btn-xs"><i class="fa fa-wrench"></i></button>
                  		<? } ?>
                  		<?if($MuestraVER!=2){?>
                  		<button id="BotonV<?=$Contv?>"  title="Eliminar" onclick="EliminarVeri(<?=$IdACT?>,<?=$Contv?>);" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button>
                  		<? } ?> 
                  	</div>
              	</div>
            </div>                                               	
                    										...
                    										if ($Contv<1) {
              												?>
              												<div align="center"><h5>No hay planes de verificación actualmente.</h5></div>
              												<?
              												}
                    										?>
</div>
<div class="slimScrollBar" style="width: 7px; position: absolute; opacity: 0.4; border-radius: 7px; z-index: 99; right: 1px; top: 0px; height: auto; display: block; background: rgb(0, 0, 0);">
</div></div></div></div>
<div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(0, 0, 0);">
</div>
                    										</div>
                    										</div>
                    										</div>
                                                ...
                                                var contenedor=document.getElementById("ingNuevoVeri");
                                                var botonVer=document.getElementById("verTodo");
                                                var listado=document.getElementById("ListadoVeri");
                                                var botonListado=document.getElementById("botonListado");
                                                var BtnIng=document.getElementById('Ingress');
                                                var BtnAct=document.getElementById('ActBtn');
                                                BtnAct.style.display="none";
                                                BtnIng.style.display="";
                                                contenedor.style.display="";
                                                botonVer.style.display="none";
                                                listado.style.display="none";
                                                botonListado.style.display="";
                                                };
                                                ...
                                                var proxima=document.getElementById("ProximaC");
                                                var frecuencia=document.getElementById("FrecuenciaC").value;

                                                 if(frecuencia==1){
                                                suma="+1 days";
                                                fechaProxima=new Date(fecha.getDate() + (1 * 24 * 3600 * 1000));
                                                }
                                                else if(frecuencia==7){
                                                suma="+7 days";
                                                fechaProxima=new Date(fecha.getDate() + (7 * 24 * 3600 * 1000));
                                                }
                                                else if(frecuencia==31){
                                                suma="+1 month";
                                                fechaProxima=new Date(fecha.setMonth(fecha.getMonth() + 1));
                                                }
                                                else if(frecuencia==180){
                                                suma="+6 month";
                                                fechaProxima=new Date(fecha.setMonth(fecha.getMonth() + 6));
                                                }
                                                else if(frecuencia==360){
                                                suma="+1 year";
                                                fechaProxima=new Date(fecha.setMonth(fecha.getMonth() + 12));
                                                }
                                                else{
                                                var x=0;
                                                } 
                                                ...
                                                <div class="modal fade" id="Calibracion<?=$IdUS?>" tabindex="-1" role="dialog" aria-labelledby="textModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                               	<h4>Plan de calibración</h4>
                                                               	<button type="button" id="botonListadoCal" class="btn btn-support5" onclick="verCal()">Ver todos</button>
																<button type="button" id="verTodoCal" class="btn btn-primary" onclick="mostrarCal();cargarCAC(0);">Ingresar nuevo</button>
                                                            </div>
                                                            <div class="modal-body">
                                                           	<div class="row">
                                                            <div id="ListadoCal" style="display:none;">
                                                            <div class="col-sm-12">
	<div class="box box-bordered style-support5">
		<div class="box-head">
			<header><h4 class="text-light">Planes de<strong> calibración</strong></h4></header>
			<div class="tools">
				<div class="btn-group btn-group-transparent">
					<a class="btn btn-equal btn-sm btn-refresh"><i class="fa fa-refresh"></i></a>
					<a class="btn btn-equal btn-sm btn-collapse"><i class="fa fa-angle-down"></i></a>
		...
		<div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height:auto">
															...
															<?
															$Contc=0;
															$query55				="SELECT * FROM Calibracionins WHERE Instrumento='$IdUS' AND Muestra!=1  order by Id DESC";
															...
															$RutCAC 				=$row55["Foto"];
															$MuestraCAC 			=$row55["Muestra"];
															$Contc++;
															?>
	<div id="ContenedorC<?=$Contc?>">
		<div class="row">
			<div class="col-sm-4">
				<li>
					<a title="Ver plan de calibración nro <?=$IdCAC?>" onclick="cargarCAC(<?=$IdCAC?>);ShowCAC();" style="font-size:14px;" target="_blank" class="btn text-support5 link">Nro. <?=$IdCAC?></a>
				</li>
			</div>
			<div id="RespC<?=$Contc?>" class="col-sm-5">
                  		
            </div>
			<div class="col-sm-3">
				<button class="btn btn-support5 btn-xs" title="Ver / Actualizar"  onclick="cargarCAC(<?=$IdCAC?>);ShowCAC();"><i class="fa fa-pencil"></i></button>
				<?if($MuestraCAC!=2){?>
                <button id="FinC<?=$Contc?>" title="Finalizar plan de calibración" onclick="FinalizarC(<?=$IdCAC?>,<?=$Contc?>)" class="btn btn-primary btn-xs"><i class="fa fa-wrench"></i></button>
            	<? } ?> 
				 <?if($MuestraCAC!=2){?>
            <button id="BotonC<?=$Contc?>" title="Eliminar" onclick="EliminarCali(<?=$IdCAC?>,<?=$Contc?>);" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button>
            <? } ?> 
			</div>
		</div>
    </div>                                                      	<?
              												...
              												if ($Contc<1) {
              												?>
              												<div align="center"><h5>No hay planes de calibración actualmente.</h5></div>
              												<?
              												}
                                                           	?>
</div>
...
<div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(0, 0, 0);">
                                                             ...
                                                             <div id="ingNuevoCali" style="display:none;">
                                                             	<div class="row">
                                                             	<form class="form-horizontal form-validate" id="formCali" role="form" enctype="multipart/form-data" method="post" action="#" novalidate>
																	<div class="col-sm-6">
															<div class="form-group">
																<div class="col-lg-12 col-md-12 col-sm-6">
																	<label for="Instrumento" class="control-label">Instrumento</label><br>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	...
																	<input type="hidden" name="Idlib" id="Idlib">
																</div>
															</div>
														</div>
														<div class="col-sm-6">
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" id="CertificadoCAC" class="form-control" name="Certificado" placeholder="Certificado Nº" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" name="Incertidumbre" id="IncertidumbreCAC" class="form-control" placeholder="Incertidumbre" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
														<div class="col-sm-6">
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" class="form-control" id="DesviacionCAC" name="Desviacion" placeholder="Desviación encontrada" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
														<div class="col-sm-6">
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<div class='input-group date' id='demo-date-uno'>
																		<input type="text" class="form-control" required name="Fecha" id="FechaCAC"/>
																		<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
																	</div>
																</div>
															</div>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<div class='input-group date' id='demo-date-dos'>
																		<input type="text" class="form-control" required name="FechaVence" id="FechaVence"/>
																		<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
																	</div>
																</div>
															</div>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<select name="Resultado" id="ResultadoCAC" class="form-control" required>
																		<option value="" id="OpcRss" selected></option>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" class="form-control" name="Responsable" id="ResponsableCAC" placeholder="Responsable" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
														<div class="col-sm-6">
															...
															<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
															  	<input name="foto" class="form-control"  type="file" id="fotoQ">
															  	</div>
                                                                </div>
														</div>
														<div class="col-sm-6">
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" class="form-control" id="ToleranciaProceso" autocomplete="off" name="ToleranciaProceso" onchange="calculo()" id="ToleranciaProceso" required>
																</div>
															</div>
															<div class="form-group">
																<div class="col-lg-12 col-md-12 col-sm-6">
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" class="form-control" id="DesviacionMaxima" name="DesviacionMaxima" autocomplete="off" onchange="calculo()" id="DesviacionMaxima" required>
																</div>
															</div>
															<div class="form-group">
																<div class="col-lg-12 col-md-12 col-sm-6">
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" class="form-control" id="ToleranciaDesviacion" name="ToleranciaDesviacion"  autocomplete="off" id="ToleranciaDesv" required readonly>
																</div>
															</div>
														</fielset>
														<script type="text/javascript">
														...
														var resultado=document.getElementById("ToleranciaDesviacion");
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<select name="Medicion" id="MedicionCAC" class="form-control" required>
																		<option value="" id="OpcMed" selected></option>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<select name="Unidad" id="UnidadCAC" class="form-control" required>
																		<option value="" id="OpcUnd" selected></option>
														...
														<div class="form-group">
																<div class="col-lg-10 col-md-8 col-sm-6">
																	<input type="text" class="form-control" id="RangoMedicionCAC" name="RangoMedicion" placeholder="Rango de medición" onChange="javascript:this.value=this.value.toUpperCase();" required >
																</div>
															</div>
														</div>
                                                             </div> 
                                                            ...
                                                            <div id="result"></div>
                                                                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                                                <button type="submit" id="Ingrass" class="btn btn-primary">Realizar Operación</button>
                                                            	<input type="button" id="ActBtnC" value="Actualizar" style="display:none;" class="btn btn-primary" onclick="ActualizarCAC();uploadFile();">
                                                            </div>
                                                        </div>
                                                       </div>
                                                   </div>
                                              	  ...
                                              	  <script type="text/javascript">
                                                function mostrarCal(){
                                                var contenedor=document.getElementById("ingNuevoCali");
                                                var botonVer=document.getElementById("verTodoCal");
                                                var listado=document.getElementById("ListadoCal");
                                                var botonListado=document.getElementById("botonListadoCal");
                                                var BtnIng=document.getElementById('Ingrass');
                                                var BtnAct=document.getElementById('ActBtnC');
                                                BtnAct.style.display="none";
                                                BtnIng.style.display="";
                                                contenedor.style.display="";
                                                botonVer.style.display="none";
		...
		<!-- EMPEZANDO EL SCRIPT DE LA CARGA ASINCRONA PARA ACTUALIZAR CON AJAX PLAN VERIFICACIÓN-->
		<script type="text/javascript">
		function cargar(Id){
		//$.get("cargar-planes.php?Id=<?=$IdUS?>&IdPlan="+Id);
		var contenedor=document.getElementById("ingNuevoVeri");
        var botonVer=document.getElementById("verTodo");
        var listado=document.getElementById("ListadoVeri");
        var botonListado=document.getElementById("botonListado");
		...
		else if (res.Frecuencia==7) {
		NFrecuencia="SEMANAL";
		}
		else if (res.Frecuencia==31) {
		NFrecuencia="MENSUAL";
		}
		else if (res.Frecuencia==180) {
		NFrecuencia="SEMESTRAL";
		}
		else if (res.Frecuencia==360) {
		NFrecuencia="ANUAL";
		}
		else{
		NFrecuencia="";
		...
		$("#IdACT").val(res.IdACT);
		$("#FechaC").val(res.Fecha);
		$("#ProximaC").val(res.Proxima);
		$("#OpcFre").remove();
		$("#FrecuenciaC").append('<option id="OpcFre" selected></option>');
		$("#OpcFre").val(res.Frecuencia);
		$("#OpcFre").html(NFrecuencia);
		$("#OpcAcc").remove();
		$("#Accion").append('<option id="OpcAcc" selected></option>');
		$("#OpcAcc").val(res.Accion);
		$("#OpcAcc").html(res.Accion);
		$("#Actividad").val(res.Actividad);
		$("#ObservacionC").val(res.Observacion);
		$("#ResponsableC").val(res.Responsable);
		...
		if (res.Formulario==1) {
		var Action="instrumento-verificacion-3.php?Id="+res.IdACT+"&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>";
		}else{
		var Action="instrumento-verificacion-2.php?Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>";
		}
		$("#formVeri").attr("action", Action); 
  		}
		});
		...
		$.ajax({
  		url: "instrumento-verificacion-3.php?Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>",    // Página destino
  		type: "GET",   // En caso de ser GET o POST
  		data: "Id="+$("#IdACT").val()+"&Instrumento=<?=$IdUS?>&Fecha="+$("#FechaC").val()+
  		"&Proxima="+$("#ProximaC").val()+"&Frecuencia="+$("#FrecuenciaC").val()+"&Accion="+$("#Accion").val()+
  		"&Actividad="+$("#Actividad").val()+"&Observacion="+$("#ObservacionC").val()+"&Responsable="+
  		$("#ResponsableC").val(),  // Parámetros a enviar en este caso
  		success: function(html){
  		  $("#results").html("<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button>Datos actualizados <strong>Correctamente!</strong></div>").fadeIn(1000);
  		  $("#results").delay(2500); 
  		  $("#results").fadeOut(1000); //funcion para procesar los datos de retorno
  		}
		});	
		}; 
		</script>
		...
		<!-- AJAX PLAN DE CALIBRACIÓN-->
		<script type="text/javascript">
		function cargarCAC(Id){
		//$.get("cargar-planes.php?Id=<?=$IdUS?>&IdPlan="+Id);
		...
		$.ajax({
  		...
  		var res = jQuery.parseJSON(data);
  		$("#Idlib").val(res.IdCAC);
  		$("#CertificadoCAC").val(res.Certificado);
  		$("#IncertidumbreCAC").val(res.Incertidumbre);
  		$("#DesviacionCAC").val(res.Desviacion);
  		$("#FechaCAC").val(res.FechaCAC);
  		$("#FechaVence").val(res.FechaVence);

  		$("#OpcRss").remove();
		$("#ResultadoCAC").append('<option id="OpcRss" selected></option>');
		$("#OpcRss").val(res.Resultado);
		$("#OpcRss").html(res.Resultado);

  		$("#ResponsableCAC").val(res.ResponsableCAC);
  		$("#ToleranciaProceso").val(res.ToleranciaProceso);
  		$("#DesviacionMaxima").val(res.DesviacionMaxima);
  		$("#ToleranciaDesviacion").val(res.ToleranciaDesviacion);

  		$("#OpcMed").remove();
		$("#MedicionCAC").append('<option id="OpcMed" selected></option>');
		$("#OpcMed").val(res.Medicion);
		$("#OpcMed").html(res.Medicion);


  		$("#OpcUnd").remove();
		$("#UnidadCAC").append('<option id="OpcUnd" selected></option>');
		$("#OpcUnd").val(res.Unidad);
		$("#OpcUnd").html(res.Unidad);

  		$("#RangoMedicionCAC").val(res.RangoMedicion);
  		$("#RutaFoto").html("<a href='instrumentosdos/certificados/"+res.RutCAC+"' target='_blank'>(Ver Foto)</a>")
  		

  		if (res.Muestra==2) {
  		document.getElementById('ActBtnC').style.display="none";
  		}

  		if (res.Formulario==1) {
		var Action="instrumento-calibracion-3.php?Id="+res.IdCAC+"&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>";
		}else{
		var Action="instrumento-calibracion-2.php?Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>";
		}
		$("#formCali").attr("action", Action); 
  		}
		});
		...
		$.ajax({
  		url: "instrumento-calibracion-3.php?Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>",    // Página destino
  		type: "GET",   // En caso de ser GET o POST
  		data: "Id="+$("#Idlib").val()+"&Instrumento=<?=$IdUS?>&Certificado="+$("#CertificadoCAC").val()+
		"&Incertidumbre="+$("#IncertidumbreCAC").val()+
		"&Desviacion="+$("#DesviacionCAC").val()+
		"&Fecha="+$("#FechaCAC").val()+
		"&FechaVence="+$("#FechaVence").val()+
		"&Resultado="+$("#ResultadoCAC").val()+
		"&Responsable="+$("#ResponsableCAC").val()+
		"&ToleranciaProceso="+$("#ToleranciaProceso").val()+
		"&DesviacionMaxima="+$("#DesviacionMaxima").val()+
		"&ToleranciaDesviacion="+$("#ToleranciaDesviacion").val()+
		"&Medicion="+$("#MedicionCAC").val()+
		"&Unidad="+$("#UnidadCAC").val()+
		"&RangoMedicion="+$("#RangoMedicionCAC").val(),
  		success: function(html){
  		  $("#result").html("<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button>Datos actualizados <strong>Correctamente!</strong></div>").fadeIn(1000);
  		  $("#result").delay(2500); 
  		  $("#result").fadeOut(1000); //funcion para procesar los datos de retorno
  		}
		});	
		};

		function uploadFile(){
  		var input = document.getElementById("fotoQ");
  		file = input.files[0];
  		  formData= new FormData();
  		    formData.append("image", file);
  		    $.ajax({
  		      url: "instrumento-calibracion-4.php?Id="+$("#Idlib").val(),
  		      type: "POST",
  		      data: formData,
  		      processData: false,
  		      contentType: false,
		...
		<script type="text/javascript">
		function EliminarVeri(Id,Cont){
		var agree=confirm("¿Desea eliminar este plan de verificación?");
		if (agree) {
		$.ajax({
  		url: "eli-planverificacion.php",    // Página destino
  		type: "GET",   // En caso de ser GET o POST
  		data: "Id="+Id,  // Parámetros a enviar en este caso
  		success: function(html){
  		$("#ContenedorV"+Cont).empty();
  		$("#ContenedorV"+Cont).append("<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button>Eliminado <strong>Correctamente!</strong></div>").fadeIn(1000);
  		$("#ContenedorV"+Cont).delay(2500);
  		$("#ContenedorV"+Cont).fadeOut(1000);
  		}
		});	
		};
		};

		function EliminarCali(Id,Cont){
		var agree=confirm("¿Desea eliminar este plan de calibración?");
		if (agree) {
		$.ajax({
  		url: "eli-plancalibracion.php",    // Página destino
  		type: "GET",   // En caso de ser GET o POST
  		data: "Id="+Id,  // Parámetros a enviar en este caso
  		success: function(html){
  		$("#ContenedorC"+Cont).empty();
  		$("#ContenedorC"+Cont).append("<div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button>Eliminado <strong>Correctamente!</strong></div>").fadeIn(1000);
  		$("#ContenedorC"+Cont).delay(2500);
  		$("#ContenedorC"+Cont).fadeOut(1000);
  		}
		});	
		};
		};
		</script>
		<!-- FIN AJAX PLAN DE CALIBRACIÓN-->

		<script type="text/javascript">
		function FinalizarV(Id,Cont){
		var agree=confirm("¿Desea finalizar este plan de verificación?");
		if (agree) {
		$.ajax({
  		url: "fin-planverificacion.php",    // Página destino
  		type: "GET",   // En caso de ser GET o POST
  		data: "Id="+Id,  // Parámetros a enviar en este caso
  		success: function(html){
  		$("#BotonV"+Cont).remove();
  		$("#FinV"+Cont).remove();
  		$("#RespV"+Cont).append("<div id='Respond' class='alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button>Finalizado <strong>Correctamente!</strong></div>").fadeIn(1000);
  		$("#Respond"+Cont).delay(2500);
  		$("#Respond").fadeOut(5000);
  		}
		});	
		...
		function FinalizarC(Id,Cont){
		var agree=confirm("¿Desea finalizar este plan de calibración?");
		if (agree) {
		$.ajax({
  		url: "fin-plancalibracion.php",    // Página destino
  		type: "GET",   // En caso de ser GET o POST
  		data: "Id="+Id,  // Parámetros a enviar en este caso
  		success: function(html){
  		$("#BotonC"+Cont).remove();
  		$("#FinC"+Cont).remove();
  		$("#RespC"+Cont).append("<div id='Respond' class='alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert'>&times;</button>Finalizado <strong>Correctamente!</strong></div>").fadeIn(1000);
  		$("#Respond"+Cont).delay(2500);
  		$("#Respond").fadeOut(5000);
  		}
		});	
