...
?>
			...
			$query			="SELECT* FROM Cotizacionesexp ORDER BY Id Desc" ;
				...
				$bto	=	'MODIFICAR';	
												...
												<tr class="gradeA">
													...
													<td class="text-right">
														...
														{
														?>                                                    
														<input name="Procesar" type="button" class="btn btn-primary" value="<?=$bto?>"  onClick="location.href='act-exporadica-2.php?Id=<?=$Id?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'"> 
                                                        <?
														}
														?> 
														...
														{
														?>  
													<input name="IMPRIMIR" type="button" class="btn btn-support5" value=" IMPRIMIR "  onclick="window.open('print-cotize.php?Id=<?=$Id?>')"  data-placement="top">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title" id="textModalLabel">Nro. Cotización <?=$Id?></h4>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-success" onclick="location.href='eli-cotizacion.php?Id=<?=$IdUSERS?>&Idmenu=<?=$Idmenux?>&Idsubmenu=<?=$Idsubmenux?>&Idopcmenu=<?=$Idopcmenux?>'">Confirmar</button>
                                                            </div>
                                                        </div><!-- /.modal-content -->
                                                    </div><!-- /.modal-dialog -->
                                                </div><!-- /.modal -->
