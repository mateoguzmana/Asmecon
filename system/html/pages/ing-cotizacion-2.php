...
$sql="INSERT INTO  Cotizaciones (Cliente, Nit, Telefono, Direccion, Ciudad, Email, Servicio, Idserv, Asunto, Informacion, Alcance, Condiciones1, Condiciones2, Condiciones3, Condiciones4, Condiciones5, Condiciones6, Condiciones7, Nota, Fecha, Usuario)";
...
window.location.href = 'ing-cotizacion.php?Idmenu=<?=$Idmenu?>&Idsubmenu=<?=$Idsubmenu?>&Idopcmenu=<?=$Idopcmenu?>';
</script>	
